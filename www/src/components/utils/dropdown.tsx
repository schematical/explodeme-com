    ...
    >
      ...
      <span className="absolute right-0 top-full origin-top-left"> 
        <Transition
          ...
          show={dropdownOpen}
          as="ul"
          className="origin-top-right absolute top-full right-0 w-40 bg-white py-2 ml-4 rounded shadow-lg transform transition ease-out data-[enter]:data-[closed]:-translate-y-2 data-[closed]:opacity-0"
